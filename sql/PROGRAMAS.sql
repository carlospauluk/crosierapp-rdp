...
VALUES ('21cf2617-a859-4cc8-aaf7-c3a612e429e5','UTILS PUSH LIST PDF', '/utils/push/list/PDFs', 'b10ef8c0-841f-4688-9ee2-30e39639be8a', null, now(), now(), 1, 1, 1);
...
INSERT INTO cfg_program(uuid, descricao, url, app_uuid, entmenu_uuid ,inserted, updated, estabelecimento_id, user_inserted_id, user_updated_id)
VALUES ('5a70c308-6944-4f5f-a44d-77bad38bdd04','UTILS PUSH LIST IMAGENS', '/utils/push/list/imagens', 'b10ef8c0-841f-4688-9ee2-30e39639be8a', null, now(), now(), 1, 1, 1);
